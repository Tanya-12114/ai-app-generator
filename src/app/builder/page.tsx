    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        <header className="border-b border-gray-200 pb-4 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-black text-gray-900 tracking-tight">Metadata Application Runtime Sandbox</h1>
            <p className="text-sm text-gray-500 mt-1">JSON config → live full-stack app (UI + dynamic CRUD + workflows)</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          <div className="space-y-2">
            <label className="text-xs font-bold uppercase tracking-wider text-gray-500">JSON Configuration Interface Editor</label>
            <textarea
              value={jsonText}
            ...
            />
            {!parsedJson && <p className="text-xs text-red-500 font-medium">⚠️ Native Parser Blocked: Invalid syntax structure.</p>}
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold uppercase tracking-wider text-gray-500">Live Dynamic Compilation Engine Canvas</label>
            {parsedJson ? <AppRuntime rawConfig={parsedJson} /> : (
